...
while (x<numbernumber_of_accounts_made):
    ...
    sleep(5)
    Next = browser.find_element_by_css_selector("button[class = 'VfPpkd-LgbsSe VfPpkd-LgbsSe-OWXEXe-k8QpJ VfPpkd-LgbsSe-OWXEXe-dgl2Hf nCP5yc AjY5Oe DuMIQc qIypjc TrZEUc']")#if cant find use: browser.find_element_by_tag_name('body').send_keys(Keys.ENTER)
    Next.click()
    ...
    sleep(5)
    Verify = browser.find_element_by_css_selector("button[class = 'VfPpkd-LgbsSe VfPpkd-LgbsSe-OWXEXe-k8QpJ VfPpkd-LgbsSe-OWXEXe-dgl2Hf nCP5yc AjY5Oe DuMIQc qIypjc TrZEUc']")#if cant find use: browser.find_element_by_tag_name('body').send_keys(Keys.ENTER)
    Verify.click()
    ...
    next_button = browser.find_element_by_css_selector("button[class = 'VfPpkd-LgbsSe VfPpkd-LgbsSe-OWXEXe-k8QpJ VfPpkd-LgbsSe-OWXEXe-dgl2Hf nCP5yc AjY5Oe DuMIQc qIypjc TrZEUc']")
    next_button.click()

    sleep(2)    
    skip_button = browser.find_element_by_css_selector("button[class = 'VfPpkd-LgbsSe VfPpkd-LgbsSe-OWXEXe-k8QpJ VfPpkd-LgbsSe-OWXEXe-dgl2Hf nCP5yc AjY5Oe DuMIQc qIypjc TrZEUc']")
    skip_button.click()
